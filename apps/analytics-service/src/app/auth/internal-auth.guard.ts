...
// Same guard shape as content-service's; duplicated rather than shared
// because each service owns its trust boundary (DB-per-service spirit).
@Injectable()
